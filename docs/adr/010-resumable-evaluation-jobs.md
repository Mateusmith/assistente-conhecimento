...
chave unica e renovam a lease durante o processamento. Jobs abandonados podem ser
retomados por outra replica. O usuario pode solicitar cancelamento e consultar progresso.

## Consequencias

Clientes precisam consultar o recurso ate um estado terminal. Em troca, datasets longos

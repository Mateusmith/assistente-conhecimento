...
| Arquivo disfarçado ou malware | lista positiva, assinatura PDF/PNG/JPEG, decodificacao e ClamAV fail-closed |
| Corrupcao no S3 | SHA-256 no banco, no metadado e recalculado na leitura |
| Exaustao por upload/OCR/imagem | tamanho, quota, paginas, DPI, timeout, dimensoes e limite de pixels |
...
| Imagem privada enviada sem consentimento | visao externa desativada por padrao e opt-in separado obrigatorio |
| Instrucao dentro da imagem | prompt visual ignora instrucoes; descricao volta como dado e passa pelo detector |
| Falsa explicabilidade | proveniencia de indice, estrategia, prompt e fontes; nenhuma alegacao de cadeia de pensamento |
| Dataset perdido em reinicio | lote limitado, resultado unico por caso, lease, progresso e retomada por outra replica |
...
- modelos de visao podem descrever incorretamente; citacao e benchmark continuam obrigatorios;
